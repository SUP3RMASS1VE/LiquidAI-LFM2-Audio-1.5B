  ...
  run: [
    // windows nvidia
    {
      ...
      "params": {
        ...
        "conda": {
          "path": "{{args && args.venv ? args.venv : 'venv'}}",
          "python": "python=3.12"
        },
        "message": [
          ...
          "{{args && args.sageattention ? 'uv pip install https://github.com/woct0rdho/SageAttention/releases/download/v2.1.1-windows/sageattention-2.1.1+cu128torch2.7.0-cp312-cp312-win_amd64.whl' : ''}}",
        ]
      },
      "next": null
    },
    ...
    // linux nvidia
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "uv pip install https://github.com/Dao-AILab/flash-attention/releases/download/v2.7.4.post1/flash_attn-2.7.4.post1+cu12torch2.7cxx11abiTRUE-cp312-cp312-linux_x86_64.whl",
